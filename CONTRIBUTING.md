...
We are focused on translating the new testament first as it contains more urgent information (like how to get saved & live our lives).
...
- g444
  ...
  - `people` when not referring to a specific number of persons
- g435
  - `man`
- g1135
  - `woman`
...
- g165
  - `age`
  - Directly translates as `eon`, but the meaning of "eon" in modern english is has drifted from the original meaning.
- g5610
